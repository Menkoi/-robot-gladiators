...
for (var i = 0; i < enemyNames.length; i++) {
  ...
  if (playerHealth > 0) {
    ...
    if (playerHealth > 0 && i < enemyNames.length - 1) {
        //ask if player wants to sue the store before next round
...
var endGame = function() {
    ...
    // ask the player if they liked to play again
...
var shop = function() {
    ...
    var shopOptionPrompt = window.prompt(
        "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the shote? Please enter one: 'REFILL', 'UPGRADE', or 'LEAVE' to make a choice."
    );
